...
public class UserTestData {
    ...
    public static final User YAMCHEKOV = new User(1, "Ямчеков Н.А", "fr@ya.ru", "password", "ул. Стокгольма 28", true, new Date(), EnumSet.of(ROLE_PROFESSOR, ROLE_STUDENT));
    ...
    public static User getUpdated() {
        ...
        updated.setRoles(Collections.singletonList(ROLE_PROFESSOR));
        return updated;
    }

    public static void assertMatch(User actual, User expected) {
        assertThat(actual).isEqualToIgnoringGivenFields(expected, "registered", "courses", "password");
    }
    ...
    public static void assertMatch(Iterable<User> actual, Iterable<User> expected) {
        assertThat(actual).usingElementComparatorIgnoringFields("registered", "courses", "password").isEqualTo(expected);
    }
