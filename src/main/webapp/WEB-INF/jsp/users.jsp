...
<script type="text/javascript" src="resources/js/university.users.js" defer></script>
    ...
    <div class="container">
        ...
        <table class="table table-striped" id="datatable">
            ...
            <c:forEach items="${users}" var="user">
                <jsp:useBean id="user" type="ru.university.model.User"/>
                <tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        <label for="address" class="col-form-label"><spring:message code="user.address"/></label>
                        <input type="text" class="form-control" id="address" name="address"
                               placeholder="<spring:message code="user.address"/>">
                    </div>
